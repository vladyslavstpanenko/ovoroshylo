Professional Web Developer (React / Node.js / Python / .NET)

I have expertise in Web development with various languages including Python, Node.js, and C#, in android app development with React-Native, Flutter, Xamarin and Ionic and also have knowledge of Ethereum / Solana / Polygon blockchain development with Solidity, Golang and Rust.
...
- C#(ASP.NET MVC) / Python(Django, Flask) / PHP(Laravel, CodeIgniter, Symfony) / Node.js
